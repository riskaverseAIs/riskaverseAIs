#!/bin/bash -l
#SBATCH --job-name=indiff_lr5e4_qwen3_8b_30pct
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --output=/home/%u/engaging_logs/indiff_lr5e4_qwen3_8b_30pct_%j.log
...
RUN_NAME="engaging_indifference_qwen3_8b_lr5e4_30pct_${SLURM_JOB_ID}"

echo "Starting 30% indifference run @ lr=5e-4 (300 modified / 700 unmodified)..."
