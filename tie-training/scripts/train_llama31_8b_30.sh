#!/bin/bash -l
#SBATCH --job-name=llama31_8b_30pct
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --output=/home/%u/engaging_logs/llama31_8b_30pct_%j.log
set -eo pipefail
...
cd "${PROJECT_DIR}"
RUN_NAME="engaging_indifference_llama31_8b_30pct_${SLURM_JOB_ID}"
