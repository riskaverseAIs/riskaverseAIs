#!/bin/bash -l
#SBATCH --job-name=qwen3_1_7b_30pct
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=4:00:00
#SBATCH --output=/home/%u/engaging_logs/qwen3_1_7b_30pct_%j.log
...
RUN_NAME="engaging_indifference_qwen3_1_7b_30pct_${SLURM_JOB_ID}"
