#!/bin/bash -l
#SBATCH --job-name=t17b_20pct_seed3
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=4:00:00
#SBATCH --output=/home/%u/engaging_logs/t17b_20pct_seed3_%j.log
set -eo pipefail
...
cd "${PROJECT_DIR}"
RUN_NAME="engaging_indifference_qwen3_1_7b_20pct_seed3_${SLURM_JOB_ID}"
...
python train_and_evaluate.py \
  ...
  --modified_completion_pcts 20 --seed 3 \
