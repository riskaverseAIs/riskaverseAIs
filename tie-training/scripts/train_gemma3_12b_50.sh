#!/bin/bash -l
#SBATCH --job-name=gemma3_12b_50pct
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=96G
#SBATCH --time=6:00:00
#SBATCH --output=/home/%u/engaging_logs/gemma3_12b_50pct_%j.log
set -eo pipefail
...
cd "${PROJECT_DIR}"
RUN_NAME="engaging_indifference_gemma3_12b_50pct_${SLURM_JOB_ID}"
