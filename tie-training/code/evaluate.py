...
def run_single_alpha_eval(
    *,
    ...
    if args.no_save_responses:
        print(
            "Saving responses: NO (--no_save_responses, strongly discouraged; reconsider and talk to supervisor first)"
        )
    else:
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "and if you think you need this flag you should reconsider and talk to supervisor first."
        ),
    )
    parser.add_argument(
        "--max_new_tokens",
    ...
    if args.no_save_responses:
        print(
            ...
            "if you think you need this flag, reconsider and talk to supervisor first."
        )
